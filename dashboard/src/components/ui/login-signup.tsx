...
export default function LoginCardSection() {
  ...
  return (
    <section className="fixed inset-0 bg-zinc-950 text-zinc-50">
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 h-full w-full pointer-events-none opacity-50 mix-blend-screen"
      />

      <header className="absolute left-0 right-0 top-0 flex items-center justify-between border-b border-zinc-800/80 px-6 py-4">
        <span className="text-xs uppercase tracking-[0.14em] text-zinc-400">NOVA</span>
        <Button
          variant="outline"
      ...
      <div className="grid h-full w-full place-items-center px-4">
        <Card className="card-animate w-full max-w-sm border-zinc-800 bg-zinc-900/70 backdrop-blur supports-[backdrop-filter]:bg-zinc-900/60">
          ...
          <CardContent className="grid gap-5">
            ...
            <div className="grid gap-2">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 rounded-md p-2 text-zinc-400 -translate-y-1/2 hover:text-zinc-200"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 text-sm text-zinc-400">
                <input
                  id="remember"
                  type="checkbox"
                  className="size-4 rounded border border-zinc-700 bg-zinc-950 accent-white"
                />
                Remember me
              </label>
            ...
            <Button className="h-10 w-full rounded-lg bg-zinc-50 text-zinc-900 hover:bg-zinc-200">
              Continue
            </Button>

            <div className="relative">
              <div className="h-px w-full bg-zinc-800" />
              <span className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 bg-zinc-900/70 px-2 text-[11px] uppercase tracking-widest text-zinc-500">
                or
              </span>
            </div>
