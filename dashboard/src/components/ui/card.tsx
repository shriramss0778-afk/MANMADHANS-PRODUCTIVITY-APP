...
>(({ className, glass = true, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[18px] text-foreground shadow-[0_8px_24px_-20px_rgba(0,0,0,0.75)] transition-colors",
      glass ? "glass-strong glow-ring" : "border border-card-border bg-background-2",
      className,
    )}
    {...props}
  />
